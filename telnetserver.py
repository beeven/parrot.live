...
COLOR_CODE = [b"\033[0m",b"\033[31m",b"\033[32m",b"\033[33m",b"\033[34m",b"\033[35m",b"\033[36m",b"\033[37m" ]
COLOR_RESET = b"\033[0m"
CLEAR_SCREEN = b"\033[H\033[J"
...
def colorize(color_index, content):
    if(type(content) == str):
        content = content.encode("utf-8")
    return COLOR_CODE[color_index % len(COLOR_CODE)] + content + COLOR_RESET
...
async def handler(reader, writer):
    ...
    last_color_index = 0
    while True:
        color_index = random.randint(1,len(COLOR_CODE))
        while color_index == last_color_index:
            color_index = random.randint(1,len(COLOR_CODE))
        last_color_index = color_index
        writer.write(CLEAR_SCREEN)
        writer.write(colorize(color_index, frames[frame_index]))
        frame_index += 1
...
if __name__=="__main__":
    ...
    coro = asyncio.start_server(handler,"0.0.0.0",3000, loop=loop)
